...
class NearestNeighbor:
    def __init__(self, num_attempts=1):
        ...
        self.num_attempts = num_attempts  # Liczba prób z różnymi miastami początkowymi
    ...
    def run(self):
        ...
        for attempt in range(self.num_attempts):
            print(f"\nPróba {attempt + 1}/{self.num_attempts}")
            ...
            print(f"Wartość funkcji celu dla tej próby: {objective_value:.2f}")
...
nn = NearestNeighbor(num_attempts=1000)
